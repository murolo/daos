...
ds_obj_cpd_get_dcsh(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;

	dcs = (struct daos_cpd_sg *)oci->oci_sub_heads.ca_arrays + idx;
	return dcs->dcs_buf;
}

static inline struct daos_cpd_sub_req *
ds_obj_cpd_get_dcsr(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;

	dcs = (struct daos_cpd_sg *)oci->oci_sub_reqs.ca_arrays + idx;
	return dcs->dcs_buf;
}

static inline struct daos_cpd_disp_ent *
ds_obj_cpd_get_dcde(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;

	dcs = (struct daos_cpd_sg *)oci->oci_disp_ents.ca_arrays + idx;
	return dcs->dcs_buf;
}

static inline struct daos_shard_tgt *
ds_obj_cpd_get_tgts(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;

	dcs = (struct daos_cpd_sg *)oci->oci_disp_tgts.ca_arrays + idx;
	return dcs->dcs_buf;
}

static inline uint32_t
ds_obj_cpd_get_dcde_cnt(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;
...
static inline uint32_t
ds_obj_cpd_get_dcsr_cnt(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;
...
static inline uint32_t
ds_obj_cpd_get_tgt_cnt(crt_rpc_t *rpc, int idx)
{
	struct obj_cpd_in	*oci = crt_req_get(rpc);
	struct daos_cpd_sg	*dcs;
